...
public class AndroidUtils {
    ...
    @SuppressWarnings("deprecation")
    public static Point getScreenSizeCompat(Activity activity) {
    ...
    public static void scrollGridViewCompat(GridView listView, int position) {
        scrollAbsListView(listView, position);
    }

    private static boolean scrollAbsListView(AbsListView listView, int position) {
    ...
    public static void scrollListViewCompat(ListView listView, int position) {
        boolean scrolled = scrollAbsListView(listView, position);
        if (!scrolled) {
    ...
    private static int getIdentifier(Context context, String resIdName, String defType) {
        return JavaUtils.isNotNulNorEmptyString(resIdName) ? context.getResources().getIdentifier(resIdName, defType, context.getPackageName())
                : INVALID_RESOURCE_ID;
    }
    ...
    @SuppressWarnings("deprecation")
    @SuppressLint("NewApi")
    public static void copyTextToClipboardCompat(Context context, CharSequence text, CharSequence label) {
